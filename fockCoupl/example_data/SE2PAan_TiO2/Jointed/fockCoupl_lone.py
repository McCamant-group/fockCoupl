...
donor_orb = 217 #218 # the orbital numbers get reordered after diagonalization, need to solve this. Just check output for now
...
Eb_orb = Eb[donor_orb] #sorted(Eb)[borb]
...
plt.vlines(Eb_orb,0,20,colors='r',linestyles='dotted')
